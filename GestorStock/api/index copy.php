...
require_once 'models/Cliente.php'; // Descomente se o modelo Cliente estiver disponível
...
$cliente = new Cliente(); // Descomente se o modelo Cliente estiver disponível
$ordem = new Ordem();

$categorias = $categoria->buscarTodos();
$fornecedores = $fornecedor->buscarTodos();
$clientes = $cliente->buscarTodos(); // Descomente se o modelo Cliente estiver disponível
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_cliente = $_POST['cliente'] ?: null; // Define null se "Nenhum" for selecionado
...
<body>
    ...
    <form action="" method="POST">
        ...
        <select id="categoria" name="categoria" required>
            <option value="">Placeholde 1</option>
